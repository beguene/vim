...
if has("gui_running")
	...
	" -> Line info  
	hi LineNr         guibg=#000000 guifg=#3D3D3D gui=none
	hi StatusLine     guibg=#FFFFFF guifg=#000000 gui=none ctermbg=white
...
elseif &t_Co == 8
  ...
  " -> Line info  
  hi LineNr         ctermbg=0  ctermfg=7  cterm=none
  hi StatusLine     ctermbg=0  ctermfg=7  cterm=white
  hi StatusLineNC   ctermbg=0  ctermfg=7  cterm=none
